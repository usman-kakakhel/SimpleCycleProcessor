...
set_property PACKAGE_PIN V13 [get_ports {pcO[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[0]}]
set_property PACKAGE_PIN V3 [get_ports {pcO[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[1]}]
set_property PACKAGE_PIN W3 [get_ports {pcO[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[2]}]
set_property PACKAGE_PIN U3 [get_ports {pcO[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[3]}]
set_property PACKAGE_PIN P3 [get_ports {pcO[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[4]}]
set_property PACKAGE_PIN N3 [get_ports {pcO[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[5]}]
set_property PACKAGE_PIN P1 [get_ports {pcO[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[6]}]
set_property PACKAGE_PIN L1 [get_ports {pcO[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pcO[7]}]
...
set_property PACKAGE_PIN T18 [get_ports bclk]						
	set_property IOSTANDARD LVCMOS33 [get_ports bclk]
#set_property PACKAGE_PIN W19 [get_ports btnL]						
	#set_property IOSTANDARD LVCMOS33 [get_ports btnL]
#set_property PACKAGE_PIN T17 [get_ports btnR]						
	#set_property IOSTANDARD LVCMOS33 [get_ports btnR]
set_property PACKAGE_PIN U17 [get_ports breset]						
